    ...
    <ul class="sidebar-nav" id="sidebar-nav">
      ...
      <li class="nav-item">
        <a class="nav-link collapsed" data-bs-target="#components-nav" data-bs-toggle="collapse" href="#">
          <i class="bi bi-menu-button-wide"></i><span>Quản Lý Admin</span><i class="bi bi-chevron-down ms-auto"></i>
        </a>
      ...
      <li class="nav-item">
        ...
        <ul id="forms-nav" class="nav-content collapse " data-bs-parent="#sidebar-nav">
          <li>
            <a href="{{ route('categories') }}">{{--  <a href="forms-elements.html"> --}}
              <i class="bi bi-circle"></i><span>Xem Danh Mục</span>
            </a>
          </li>
          <li>
            <a href="{{ route('categories.add') }}">{{-- <a href="forms-layouts.html"> --}}
      ...
      <li class="nav-item">
        ...
        <ul id="tables-nav" class="nav-content collapse " data-bs-parent="#sidebar-nav">
          <li>
            <a href="{{ route('products') }}">{{-- <a href="tables-general.html"> --}}
              <i class="bi bi-circle"></i><span>Xem Sản Phẩm</span>
            </a>
          </li>
          <li>
            <a href="{{ route('products.add') }}">{{-- <a href="tables-data.html"> --}}
      ...
      <li class="nav-item">
        ...
        <ul id="charts-nav" class="nav-content collapse " data-bs-parent="#sidebar-nav">
          <li>
            <a href="{{ route('customers') }}">{{--   <a href="charts-chartjs.html"> --}}
