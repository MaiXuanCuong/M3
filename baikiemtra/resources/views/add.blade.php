...
<html lang="en">
  ...
  <body>
    ...
    <div class="mb-3">
        ...
        <input type="text" name="name" class="form-control" id="exampleFormControlInput1" placeholder="Tên Sách">
        @error('name')
    ...
    <div class="row">
      <div class="mb-3">
        ...
        <input type="text" name="pages" class="form-control" id="exampleFormControlInput1" placeholder="Số Trang">
        @error('pages')
        <div class="alert alert-danger">{{ $message }}</div>
    @enderror
      </div>
      <div class="mb-3">
        ...
        <input type="text" name="years" class="form-control" id="exampleFormControlInput1" placeholder="Năm Xuất Bản">
        @error('years')
        <div class="alert alert-danger">{{ $message }}</div>
    @enderror
      </div>
